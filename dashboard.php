        ...
        <div class="dashboard">
            ...
            <div class="panel_usuario">
                <div class="contenedor_todas_las_apuestas">
                    <a name="casino"></a>
                    <div class="imagen_casinos">

                        <div class="Titulo_apuesta">
                            <h1>Apuesta en el casino</h1>
                            <hr>
                        </div>

                        <br>
                        <div class="contenido_apues_dentro">
                            <div class="tarjeta_baner">
                                <div class="dentro_tarjerta">
                                    <h1>Póquer</h1>
                                    <p>Apuesta desde</p>
                                    <p style="color: red; background-color: rgb(16, 233, 16);">$50MXN</p>
                            ...
                            <div class="tarjeta_baner"
                                style="background-image:url(images/gambling-g47aec4d96_640.jpg);">
                                <div class="dentro_tarjerta">
                                    <h1>Ruleta</h1>
                                    <p>Apuesta desde</p>
                                    <p style="color: red; background-color: rgb(16, 233, 16);">$100MXN</p>
                                    <br>
                                    <br>
                                    <div style="text-align: center; align-items: center; margin: 0 auto; border-radius: 10px; vertical-align: middle;
                                height: 30px; background-color: rgb(71, 21, 31); width:70%;">
                            ...
                            <div class="tarjeta_baner"
                                style="background-image:url(https://cdn.pixabay.com/photo/2013/07/25/12/06/card-game-167051_960_720.jpg);">
                                <div class="dentro_tarjerta">
                                    <h1>Blackjack</h1>
                                    <p>Apuesta desde</p>
                                    <p style="color: red; background-color: rgb(16, 233, 16);">$60MXN</p>
                                    <br>
                                    <br>
                                    <div style=" text-align: center; align-items: center; margin: 0 auto; border-radius: 10px; vertical-align: middle;
                                    height: 30px; background-color: rgb(71, 21, 31); width:70%;">
                        ...
                        <br>
                        <div class="imagen_casinos"
                            style="background-image: url(images/pexels-tembela-bohle-1884574.jpg); ">
                            <div class="Titulo_apuesta">
                                <a name="football"></a>
                                <br>
                                <h1 style="background-color: rgba(24, 22, 22, 0.603); ">Apuesta por tu equipo favorito
                                    de Football
                                </h1>
                                <hr>
                                <br>
                                <div class="contenido_apues_dentro">
                                    <div class="tarjeta_baner"
                                        style="background-image: url(https://images.news18.com/ibnlive/uploads/2021/03/1614676202_c75c28559e048ecb2e0c232a374ebaa2.jpg);">
                                        <div class="dentro_tarjerta">
                                            <h1>Real Madrid</h1>
                                            <p>Apuesta desde</p>
                                            <br>
                                            <p style="color: red; background-color: rgb(16, 233, 16);">$500MXN</p>
                                    ...
                                    <div class="tarjeta_baner"
                                        style="background-image:url(https://upload.wikimedia.org/wikipedia/en/thumb/4/47/FC_Barcelona_%28crest%29.svg/190px-FC_Barcelona_%28crest%29.svg.png);">
                                        <div class="dentro_tarjerta">
                                            <h1>FC Barcelona</h1>
                                            <p>Apuesta desde</p>
                                            <br>
                                            <p style="color: red; background-color: rgb(16, 233, 16);">$600MXN</p>
                                            <br>
                                            <br>
                                            <div style="text-align: center; align-items: center; margin: 0 auto; border-radius: 10px; vertical-align: middle;
                                height: 30px; background-color: rgb(71, 21, 31); width:70%;">
                        ...
                        <div class="imagen_casinos"
                            style="background-image: url(https://cdn.pixabay.com/photo/2016/11/29/03/53/athletes-1867185_960_720.jpg); ">
                            <div class="Titulo_apuesta">
                                <a name="americano"></a>
                                <br>
                                <h1 style="background-color: rgba(24, 22, 22, 0.603); ">Apuesta por tu equipo favorito
                                ...
                                <div class="contenido_apues_dentro">
                                    <div class="tarjeta_baner"
                                        style="background-image: url(https://www.tshaonline.org/images/handbook/entries/DD/dallas-cowboys-star-logo.jpg);">
                                        <div class="dentro_tarjerta">
                                    ...
                                    <div class="tarjeta_baner"
                                        style="background-image:url(https://lh3.googleusercontent.com/QXTGFbTl0wLSkPLXeW2q3kb07-qgXimGZbPfftb6CshhQSexCsi9flXu0OhIzFTp2wjz);">
                                        <div class="dentro_tarjerta">
                        ...
                        <div class="imagen_casinos"
                        style="background-image: url(https://i0.wp.com/naciondeportes.com/wp-content/uploads/2020/05/chicago-bulls-despues-de-michael-jordan.jpg?fit=1000%2C600&ssl=1); ">
                        <div class="Titulo_apuesta">
                            <a name="baloncesto"></a>
                            <br>
                            <h1 style="background-color: rgba(24, 22, 22, 0.603); ">Apuesta por tu equipo favorito
                            ...
                            <div class="contenido_apues_dentro">
                                <div class="tarjeta_baner"
                                    style="background-image: url(https://a.espncdn.com/i/teamlogos/nba/500/chi.png);">
                                    <div class="dentro_tarjerta">
                                        <h1>Chicago bulls</h1>
                                        <p>Apuesta desde</p>
                                        <br>
                                ...
                                <div class="tarjeta_baner"
                                    style="background-image:url(https://upload.wikimedia.org/wikipedia/en/thumb/f/fb/Miami_Heat_logo.svg/800px-Miami_Heat_logo.svg.png);">
                                    <div class="dentro_tarjerta">
                                        <h1>Miami heat</h1>
                                        <p>Apuesta desde</p>
                                        <br>
                            ...
                            height: 30px; background-color: rgb(71, 21, 31); width:70%;">
                                ...
                                <div class="tarjeta_baner"
                                    style="background-image:url(https://a.espncdn.com/combiner/i?img=/i/teamlogos/nba/500/lac.png);">
                                    <div class="dentro_tarjerta">
                                        <h1>LA Clippers</h1>
                                        <p>Apuesta desde</p>
                                        <br>
                        ...
                        <div class="imagen_casinos"style="background-image: url(https://cdn.pixabay.com/photo/2018/05/15/23/02/football-stadium-3404535_960_720.jpg); ">
                            <div class="Titulo_apuesta">
                                <br>
                                <hr>
                                <a name="apuestas_football"></a>
                                <h1>Tabla de Apuestas</h1>
                                <hr>
                                <div class="tabla_de_apuestas">
