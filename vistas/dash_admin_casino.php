...
<body>
    ...
    <a href="dash_admin.php">Apuestas</a>
        ...
        <a href="dash_admin_baloncesto.php">Baloncesto</a>a>
    </div>
    <div class="contenido_principal">
        ...
        <div class="dashboard2">
            ...
            if ($row['email']) {
                ...
                ";
                $consulta = "SELECT * FROM `opciones_de_apuesta` WHERE `id_categoria`=1";
                $resultado = mysqli_query($conexion, $consulta);
                ...
                echo " 
                <form action='../db/editar_casino.php' method='POST'>
                    <div class='titulos_tablas'>
